            ...
            <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-1">
                        ...
                        <x-text-input type="text" name="isbn" :value="old('isbn', $book->isbn)" required />
                        <x-input-error :messages="$errors->get('isbn')" />
                    </div>

                    <div class="space-y-1">
                        <x-input-label value="Judul Buku" />
                        <x-text-input type="text" name="title" :value="old('title', $book->title)" required />
                    ...
                    <div class="space-y-1">
                        ...
                        @if ($book->cover_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $book->cover_image) }}" class="h-24 w-20 rounded-lg object-cover shadow-sm">
                            </div>
                        @endif
